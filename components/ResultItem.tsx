                    ...
                    <>
                        ...
                        <div className="space-y-1">
                            <div className="flex justify-between">
                                ...
                                <span className={`text-xs ${
                                    metadata.title.length >= config.titleMin && metadata.title.length <= config.titleMax 
                            ...
                            <div className="relative">
                                <input 
                                    type="text" 
                                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 outline-none text-slate-800 dark:text-slate-200 pr-10"
                        ...
                        <div className="space-y-1">
                            <div className="flex justify-between">
                                ...
                                <span className={`text-xs ${metadata.description.length <= config.descMax ? 'text-slate-400' : 'text-red-500'}`}>
                                    {metadata.description.length} / {config.descMax}
                                </span>
                            </div>
                            <div className="relative">
                                <textarea 
                                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-600 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 outline-none text-slate-800 dark:text-slate-200 pr-10 resize-none"
                                    rows={2}
                        ...
                        <div className="space-y-1">
                            <div className="flex justify-between">
                                ...
                                <span className={`text-xs ${
                                    metadata.keywords.length >= config.keywordsMin && metadata.keywords.length <= config.keywordsMax 
                                    ? 'text-green-600 dark:text-green-400' 
                                    : 'text-red-500 dark:text-red-400'
                                }`}>
